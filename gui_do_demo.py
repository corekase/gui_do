...
class Demo:
    def __init__(self):
        ...
        add(ButtonGroup('b01', gridded(0, 1), 0, 'Box 1', 'pb1'))
        add(ButtonGroup('b02', gridded(0, 2), 0, 'Box 2', 'pb1'))
        add(ButtonGroup('b03', gridded(0, 3), 0, 'Box 3', 'pb1'))
        add(ButtonGroup('b04', gridded(0, 4), 0, 'Box 4', 'pb1'))
        add(ButtonGroup('b05', gridded(0, 5), 0, 'Box 5', 'pb1'))
        add(ButtonGroup('b06', gridded(1, 1), 1, 'Round 1', 'pb2'))
        add(ButtonGroup('b07', gridded(1, 2), 1, 'Round 2', 'pb2'))
        add(ButtonGroup('b08', gridded(1, 3), 1, 'Round 3', 'pb2'))
        add(ButtonGroup('b09', gridded(1, 4), 1, 'Round 4', 'pb2'))
        add(ButtonGroup('b10', gridded(1, 5), 1, 'Round 5', 'pb2'))
        add(ButtonGroup('b11', gridded(2, 1), 2, 'Angle 1', 'pb3'))
        add(ButtonGroup('b12', gridded(2, 2), 2, 'Angle 2', 'pb3'))
        add(ButtonGroup('b13', gridded(2, 3), 2, 'Angle 3', 'pb3'))
        add(ButtonGroup('b14', gridded(2, 4), 2, 'Angle 4', 'pb3'))
        add(ButtonGroup('b15', gridded(2, 5), 2, 'Angle 5', 'pb3'))
        add(ButtonGroup('b16', gridded(3, 1), 3, 'Radio 1', 'pb4'))
        add(ButtonGroup('b17', gridded(3, 2), 3, 'Radio 2', 'pb4'))
        add(ButtonGroup('b18', gridded(3, 3), 3, 'Radio 3', 'pb4'))
        add(ButtonGroup('b19', gridded(3, 4), 3, 'Radio 4', 'pb4'))
        add(ButtonGroup('b20', gridded(3, 5), 3, 'Radio 5', 'pb4'))
        add(ButtonGroup('b21', gridded(4, 1), 4, 'Check 1', 'pb5'))
        add(ButtonGroup('b22', gridded(4, 2), 4, 'Check 2', 'pb5'))
        add(ButtonGroup('b23', gridded(4, 3), 4, 'Check 3', 'pb5'))
        add(ButtonGroup('b24', gridded(4, 4), 4, 'Check 4', 'pb5'))
        add(ButtonGroup('b25', gridded(4, 5), 4, 'Check 5', 'pb5'))
        add(ButtonGroup('b26', gridded(5, 1), 0, 'Mix 1', 'pb6'))
        add(ButtonGroup('b27', gridded(5, 2), 1, 'Mix 2', 'pb6'))
        add(ButtonGroup('b28', gridded(5, 3), 2, 'Mix 3', 'pb6'))
        add(ButtonGroup('b29', gridded(5, 4), 3, 'Mix 4', 'pb6'))
        add(ButtonGroup('b30', gridded(5, 5), 4, 'Mix 5', 'pb6'))
