...
class Demo:
    ...
    def __init__(self):
        ...
        g1.button_group('bg1', 'bg1b01', g1.gridded(0, 1), ButtonStyle.Box, 'Box 1')
        ...
        g1.button_group('bg2', 'bg2b01', g1.gridded(1, 1), ButtonStyle.Round, 'Round 1')
        ...
        g1.button_group('bg3', 'bg3b01', g1.gridded(2, 1), ButtonStyle.Angle, 'Angle 1')
        ...
        g1.button_group('bg4', 'bg4b01', g1.gridded(3, 1), ButtonStyle.Radio, 'Radio 1')
        ...
        g1.button_group('bg5', 'bg5b01', g1.gridded(4, 1), ButtonStyle.Check, 'Check 1')
        ...
        g1.button_group('bg6', 'bg6b01', g1.gridded(5, 1), ButtonStyle.Box, 'Mix 1')
        ...
        self.label1 = g1.label(g1.gridded(0, 0), 'ID: bg1b01', True)
        self.label2 = g1.label(g1.gridded(1, 0), 'ID: bg2b01', True)
        self.label3 = g1.label(g1.gridded(2, 0), 'ID: bg3b01', True)
        self.label4 = g1.label(g1.gridded(3, 0), 'ID: bg4b01', True)
        self.label5 = g1.label(g1.gridded(4, 0), 'ID: bg5b01', True)
        self.label6 = g1.label(g1.gridded(5, 0), 'ID: bg6b01', True)
