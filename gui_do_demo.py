...
class Demo:
    def __init__(self):
        ...
        add(Label(gridded(0, 0), 'Boxed', True))
        add(Label(gridded(1, 0), 'Rounded', True))
        add(Label(gridded(2, 0), 'Angled', True))
        add(Label(gridded(3, 0), 'Radioed', True))
        add(Label(gridded(4, 0), 'Checked', True))
        add(Label(gridded(5, 0), 'Mixed', True))
