...
class Demo:
    def __init__(self):
        ...
        add(GroupButton('gb01', gridded(0, 1), 0, 'Box 1', 'pb1'))
        add(GroupButton('gb02', gridded(0, 2), 0, 'Box 2', 'pb1'))
        add(GroupButton('gb03', gridded(0, 3), 0, 'Box 3', 'pb1'))
        add(GroupButton('gb04', gridded(0, 4), 0, 'Box 4', 'pb1'))
        add(GroupButton('gb05', gridded(0, 5), 0, 'Box 5', 'pb1'))
        add(GroupButton('gb06', gridded(1, 1), 1, 'Round 1', 'pb2'))
        add(GroupButton('gb07', gridded(1, 2), 1, 'Round 2', 'pb2'))
        add(GroupButton('gb08', gridded(1, 3), 1, 'Round 3', 'pb2'))
        add(GroupButton('gb09', gridded(1, 4), 1, 'Round 4', 'pb2'))
        add(GroupButton('gb10', gridded(1, 5), 1, 'Round 5', 'pb2'))
        add(GroupButton('gb11', gridded(2, 1), 2, 'Angle 1', 'pb3'))
        add(GroupButton('gb12', gridded(2, 2), 2, 'Angle 2', 'pb3'))
        add(GroupButton('gb13', gridded(2, 3), 2, 'Angle 3', 'pb3'))
        add(GroupButton('gb14', gridded(2, 4), 2, 'Angle 4', 'pb3'))
        add(GroupButton('gb15', gridded(2, 5), 2, 'Angle 5', 'pb3'))
        add(GroupButton('gb16', gridded(3, 1), 3, 'Radio 1', 'pb4'))
        add(GroupButton('gb17', gridded(3, 2), 3, 'Radio 2', 'pb4'))
        add(GroupButton('gb18', gridded(3, 3), 3, 'Radio 3', 'pb4'))
        add(GroupButton('gb19', gridded(3, 4), 3, 'Radio 4', 'pb4'))
        add(GroupButton('gb20', gridded(3, 5), 3, 'Radio 5', 'pb4'))
        add(GroupButton('gb21', gridded(4, 1), 4, 'Check 1', 'pb5'))
        add(GroupButton('gb22', gridded(4, 2), 4, 'Check 2', 'pb5'))
        add(GroupButton('gb23', gridded(4, 3), 4, 'Check 3', 'pb5'))
        add(GroupButton('gb24', gridded(4, 4), 4, 'Check 4', 'pb5'))
        add(GroupButton('gb25', gridded(4, 5), 4, 'Check 5', 'pb5'))
        add(GroupButton('gb26', gridded(5, 1), 0, 'Mix 1', 'pb6'))
        add(GroupButton('gb27', gridded(5, 2), 1, 'Mix 2', 'pb6'))
        add(GroupButton('gb28', gridded(5, 3), 2, 'Mix 3', 'pb6'))
        add(GroupButton('gb29', gridded(5, 4), 3, 'Mix 4', 'pb6'))
        add(GroupButton('gb30', gridded(5, 5), 4, 'Mix 5', 'pb6'))
