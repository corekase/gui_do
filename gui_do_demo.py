...
class Demo:
    def __init__(self):
        ...
        widget_height = 28
        # exit button
        g.button('exit', Rect(10, 1042, 70, widget_height), ButtonStyle.Angle, 'Exit')
        # setup for the togglebuttons
        g.set_grid_properties((85, 1042), 120, widget_height, 4)
        # switch to gui2 button
        self.gui2_Button = g.button('gui2', g.gridded(0, 0), ButtonStyle.Round, 'GUI 2')
        # control whether the background circles are drawn
        self.circles_Toggle = g.toggle('circles', g.gridded(1, 0), ButtonStyle.Round, False, 'Circles')
        # control whether the buttons and toggles window is visible
        self.Buttons_Toggle = g.toggle('Buttons_Window', g.gridded(2, 0), ButtonStyle.Round, False, 'Buttons')
        # control whether the scrollbar window is visible
        self.Scrollbars_Toggle = g.toggle('Scrollbar_Window', g.gridded(3, 0), ButtonStyle.Round, False, 'Scrollbars')
        # control whether the life window is visible
        self.life_Toggle = g.toggle('life_Window', g.gridded(4, 0), ButtonStyle.Round, False, 'Life')
        # control whether the Mandelbrot window is visible
        self.mandel_Toggle = g.toggle('mandel_Window', g.gridded(5, 0), ButtonStyle.Round, False, 'Mandelbrot')
        # make the button groups, buttons, and toggles window
        x_pos, y_pos = 50, 150
        g.set_grid_properties((10, 10), 120, widget_height, 2)
        self.Button_group_win = g.window('Button Groups, Buttons, and Toggles',
                                         (x_pos, y_pos), (g.gridded(7, 0).right + 10, g.gridded(0, 6).bottom))
        g.label(g.gridded(0, 0), 'G1 Boxed', True)
        g.label(g.gridded(1, 0), 'G2 Rounded', True)
        g.label(g.gridded(2, 0), 'G3 Angled', True)
        g.label(g.gridded(3, 0), 'G4 Radioed', True)
        g.label(g.gridded(4, 0), 'G5 Checked', True)
        g.label(g.gridded(5, 0), 'G6 Mixed', True)
        g.label(g.gridded(6, 0), 'Buttons', True)
        g.label(g.gridded(7, 0), 'Toggles', True)
        lbg1 = g.buttongroup('bg1', 'bg1b01', g.gridded(0, 1), ButtonStyle.Box, 'Box 1')
        g.buttongroup('bg1', 'bg1b02', g.gridded(0, 2), ButtonStyle.Box, 'Box 2',)
        g.buttongroup('bg1', 'bg1b03', g.gridded(0, 3), ButtonStyle.Box, 'Box 3',)
        g.buttongroup('bg1', 'bg1b04', g.gridded(0, 4), ButtonStyle.Box, 'Box 4',)
        g.buttongroup('bg1', 'bg1b05', g.gridded(0, 5), ButtonStyle.Box, 'Box 5',)
        lbg2 = g.buttongroup('bg2', 'bg2b01', g.gridded(1, 1), ButtonStyle.Round, 'Round 1')
        g.buttongroup('bg2', 'bg2b02', g.gridded(1, 2), ButtonStyle.Round, 'Round 2')
        g.buttongroup('bg2', 'bg2b03', g.gridded(1, 3), ButtonStyle.Round, 'Round 3')
        g.buttongroup('bg2', 'bg2b04', g.gridded(1, 4), ButtonStyle.Round, 'Round 4')
        g.buttongroup('bg2', 'bg2b05', g.gridded(1, 5), ButtonStyle.Round, 'Round 5')
        lbg3 = g.buttongroup('bg3', 'bg3b01', g.gridded(2, 1), ButtonStyle.Angle, 'Angle 1')
        g.buttongroup('bg3', 'bg3b02', g.gridded(2, 2), ButtonStyle.Angle, 'Angle 2')
        g.buttongroup('bg3', 'bg3b03', g.gridded(2, 3), ButtonStyle.Angle, 'Angle 3')
        g.buttongroup('bg3', 'bg3b04', g.gridded(2, 4), ButtonStyle.Angle, 'Angle 4')
        g.buttongroup('bg3', 'bg3b05', g.gridded(2, 5), ButtonStyle.Angle, 'Angle 5')
        lbg4 = g.buttongroup('bg4', 'bg4b01', g.gridded(3, 1), ButtonStyle.Radio, 'Radio 1')
        g.buttongroup('bg4', 'bg4b02', g.gridded(3, 2), ButtonStyle.Radio, 'Radio 2')
        g.buttongroup('bg4', 'bg4b03', g.gridded(3, 3), ButtonStyle.Radio, 'Radio 3')
        g.buttongroup('bg4', 'bg4b04', g.gridded(3, 4), ButtonStyle.Radio, 'Radio 4')
        g.buttongroup('bg4', 'bg4b05', g.gridded(3, 5), ButtonStyle.Radio, 'Radio 5')
        lbg5 = g.buttongroup('bg5', 'bg5b01', g.gridded(4, 1), ButtonStyle.Check, 'Check 1')
        g.buttongroup('bg5', 'bg5b02', g.gridded(4, 2), ButtonStyle.Check, 'Check 2')
        g.buttongroup('bg5', 'bg5b03', g.gridded(4, 3), ButtonStyle.Check, 'Check 3')
        g.buttongroup('bg5', 'bg5b04', g.gridded(4, 4), ButtonStyle.Check, 'Check 4')
        g.buttongroup('bg5', 'bg5b05', g.gridded(4, 5), ButtonStyle.Check, 'Check 5')
        lbg6 = g.buttongroup('bg6', 'bg6b01', g.gridded(5, 1), ButtonStyle.Box, 'Mix 1')
        g.buttongroup('bg6', 'bg6b02', g.gridded(5, 2), ButtonStyle.Round, 'Mix 2')
        g.buttongroup('bg6', 'bg6b03', g.gridded(5, 3), ButtonStyle.Angle, 'Mix 3')
        g.buttongroup('bg6', 'bg6b04', g.gridded(5, 4), ButtonStyle.Radio, 'Mix 4')
        g.buttongroup('bg6', 'bg6b05', g.gridded(5, 5), ButtonStyle.Check, 'Mix 5')
        g.button('b1', g.gridded(6, 1), ButtonStyle.Box, 'Button 1')
        g.button('b2', g.gridded(6, 2), ButtonStyle.Round, 'Button 2')
        g.button('b3', g.gridded(6, 3), ButtonStyle.Angle, 'Button 3')
        g.button('b4', g.gridded(6, 4), ButtonStyle.Radio, 'Button 4')
        g.button('b5', g.gridded(6, 5), ButtonStyle.Check, 'Button 5')
        g.toggle('t1', g.gridded(7, 1), ButtonStyle.Box, False, 'Push 1', 'Raise 1')
        g.toggle('t2', g.gridded(7, 2), ButtonStyle.Round, False, 'Push 2', 'Raise 2')
        g.toggle('t3', g.gridded(7, 3), ButtonStyle.Angle, False, 'Push 3', 'Raise 3')
        g.toggle('t4', g.gridded(7, 4), ButtonStyle.Radio, False, 'Push 4', 'Raise 4')
        g.toggle('t5', g.gridded(7, 5), ButtonStyle.Check, False, 'Push 5', 'Raise 5')
        g.set_grid_properties((10, g.gridded(0, 5).bottom + 4), 122, widget_height, 0, False)
        self.label1 = g.label(g.gridded(0, 0), f'ID: {lbg1.read_id()}', True)
        self.label2 = g.label(g.gridded(1, 0), f'ID: {lbg2.read_id()}', True)
        self.label3 = g.label(g.gridded(2, 0), f'ID: {lbg3.read_id()}', True)
        self.label4 = g.label(g.gridded(3, 0), f'ID: {lbg4.read_id()}', True)
        self.label5 = g.label(g.gridded(4, 0), f'ID: {lbg5.read_id()}', True)
        self.label6 = g.label(g.gridded(5, 0), f'ID: {lbg6.read_id()}', True)
        # make the scrollbar window
        y_pos += 248
        self.Scrollbar_win = g.window('Scrollbars', (x_pos, y_pos), (320, 362))
        x = y = 10
        g.scrollbar('Scrollbar_a', Rect(x, y, 300, 20), Orientation.Horizontal, ArrowPosition.Skip, (100, 0, 30, 10))
        y += 22
        g.scrollbar('Scrollbar_b', Rect(x, y, 300, 20), Orientation.Horizontal, ArrowPosition.Split, (100, 0, 30, 10))
        y += 22
        g.scrollbar('Scrollbar_c', Rect(x, y, 300, 20), Orientation.Horizontal, ArrowPosition.Near, (100, 0, 30, 10))
        y += 22
        g.scrollbar('Scrollbar_d', Rect(x, y, 300, 20), Orientation.Horizontal, ArrowPosition.Far, (100, 0, 30, 10))
        y += 24
        g.scrollbar('Scrollbar_e', Rect(x, y, 20, 250), Orientation.Vertical, ArrowPosition.Skip, (100, 0, 30, 10))
        x += 22
        g.scrollbar('Scrollbar_f', Rect(x, y, 20, 250), Orientation.Vertical, ArrowPosition.Split, (100, 0, 30, 10))
        x += 22
        g.scrollbar('Scrollbar_g', Rect(x, y, 20, 250), Orientation.Vertical, ArrowPosition.Near, (100, 0, 30, 10))
        x += 22
        g.scrollbar('Scrollbar_h', Rect(x, y, 20, 250), Orientation.Vertical, ArrowPosition.Far, (100, 0, 30, 10))
        g.image('realize', Rect(x + 25, y, 210, 210), 'realize.png', False)
        b.set_font('scroll')
        g.label((x + 30, y + 215), 'Scrollbars!', True)
        b.set_font('normal')
        # make the Conway's Game of Life window
        x_pos += 327
        width, height = 600, 600
        self.life_win = g.window('Conway\'s Game of Life', (x_pos, y_pos), (width, height))
        self.canvas = g.canvas('life', Rect(10, 10, width - 20, height - (widget_height * 2)), canvas_callback=self.handle_Canvas, automatic_pristine=True)
        ...
        g.button('life_reset', g.gridded(0, 0), ButtonStyle.Angle, 'Reset')
        # toggle whether or not the simulation is processing
        self.Toggle_life = g.toggle('run', g.gridded(1, 0), ButtonStyle.Round, False, 'Stop', 'Start')
        width, height = 600, 600
        pos = x_pos + 607, y_pos
        mandel_overall = Rect(10, 10, width - 20, height - (widget_height * 2))
        self.mandel_win = g.window('Mandelbrot', pos, (width, height))
        self.mandel_canvas = g.canvas('mandel', mandel_overall)
        ...
        self.canvas1 = g.canvas('can1', Rect(10, 10, chalfx + 10, chalfy + 10))
        self.canvas2 = g.canvas('can2', Rect(13 + chalfx + 5, 10, chalfx + 10, chalfy + 10))
        self.canvas3 = g.canvas('can3', Rect(10, 13 + chalfy + 5, chalfx + 10, chalfy + 10))
        self.canvas4 = g.canvas('can4', Rect(13 + chalfx + 5, 13 + chalfy + 5, chalfx + 10, chalfy + 10))
        ...
        g.button('mandel_reset', g.gridded(0, 0), ButtonStyle.Angle, 'Reset')
        g.button('iterative', g.gridded(1, 0), ButtonStyle.Round, 'Iterative')
        g.button('recursive', g.gridded(2, 0), ButtonStyle.Round, 'Recursive')
        g.button('1split', g.gridded(3, 0), ButtonStyle.Round, '1M 4 Tasks')
        g.button('4split', g.gridded(4, 0), ButtonStyle.Round, '4M 4 Tasks')
        # set cursor image
        ...
        self.gui2.button('return', Rect(10, 1042, 70, widget_height), ButtonStyle.Angle, 'Back')
