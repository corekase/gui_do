...
class Demo:
    def __init__(self):
        ...
        self.pb_win = Window('Pushbuttons, Buttons, and Togglebuttons', (50, 150), (918, 200))
        set_grid_properties((10, 10), 110, widget_height, 2)
        add(Label(gridded(0, 0), 'PB Boxed', True))
        add(Label(gridded(1, 0), 'PB Rounded', True))
        add(Label(gridded(2, 0), 'PB Angled', True))
        add(Label(gridded(3, 0), 'PB Radioed', True))
        add(Label(gridded(4, 0), 'PB Checked', True))
        add(Label(gridded(5, 0), 'PB Mixed', True))
        add(Label(gridded(6, 0), 'Buttons', True))
        add(Label(gridded(7, 0), 'Toggled', True))
        add(PushButtonGroup('pb01', gridded(0, 1), 0, 'Box 1', 'pb1'))
        add(PushButtonGroup('pb02', gridded(0, 2), 0, 'Box 2', 'pb1'))
        add(PushButtonGroup('pb03', gridded(0, 3), 0, 'Box 3', 'pb1'))
        add(PushButtonGroup('pb04', gridded(0, 4), 0, 'Box 4', 'pb1'))
        add(PushButtonGroup('pb05', gridded(0, 5), 0, 'Box 5', 'pb1'))
        add(PushButtonGroup('pb06', gridded(1, 1), 1, 'Round 1', 'pb2'))
        add(PushButtonGroup('pb07', gridded(1, 2), 1, 'Round 2', 'pb2'))
        add(PushButtonGroup('pb08', gridded(1, 3), 1, 'Round 3', 'pb2'))
        add(PushButtonGroup('pb09', gridded(1, 4), 1, 'Round 4', 'pb2'))
        add(PushButtonGroup('pb10', gridded(1, 5), 1, 'Round 5', 'pb2'))
        add(PushButtonGroup('pb11', gridded(2, 1), 2, 'Angle 1', 'pb3'))
        add(PushButtonGroup('pb12', gridded(2, 2), 2, 'Angle 2', 'pb3'))
        add(PushButtonGroup('pb13', gridded(2, 3), 2, 'Angle 3', 'pb3'))
        add(PushButtonGroup('pb14', gridded(2, 4), 2, 'Angle 4', 'pb3'))
        add(PushButtonGroup('pb15', gridded(2, 5), 2, 'Angle 5', 'pb3'))
        add(PushButtonGroup('pb16', gridded(3, 1), 3, 'Radio 1', 'pb4'))
        add(PushButtonGroup('pb17', gridded(3, 2), 3, 'Radio 2', 'pb4'))
        add(PushButtonGroup('pb18', gridded(3, 3), 3, 'Radio 3', 'pb4'))
        add(PushButtonGroup('pb19', gridded(3, 4), 3, 'Radio 4', 'pb4'))
        add(PushButtonGroup('pb20', gridded(3, 5), 3, 'Radio 5', 'pb4'))
        add(PushButtonGroup('pb21', gridded(4, 1), 4, 'Check 1', 'pb5'))
        add(PushButtonGroup('pb22', gridded(4, 2), 4, 'Check 2', 'pb5'))
        add(PushButtonGroup('pb23', gridded(4, 3), 4, 'Check 3', 'pb5'))
        add(PushButtonGroup('pb24', gridded(4, 4), 4, 'Check 4', 'pb5'))
        add(PushButtonGroup('pb25', gridded(4, 5), 4, 'Check 5', 'pb5'))
        add(PushButtonGroup('pb26', gridded(5, 1), 0, 'Mix 1', 'pb6'))
        add(PushButtonGroup('pb27', gridded(5, 2), 1, 'Mix 2', 'pb6'))
        add(PushButtonGroup('pb28', gridded(5, 3), 2, 'Mix 3', 'pb6'))
        add(PushButtonGroup('pb29', gridded(5, 4), 3, 'Mix 4', 'pb6'))
        add(PushButtonGroup('pb30', gridded(5, 5), 4, 'Mix 5', 'pb6'))
        ...
        add(ToggleButton('tb1', gridded(7, 1), 0, False, 'Push 1', 'Raise 1'))
        add(ToggleButton('tb2', gridded(7, 2), 1, False, 'Push 2', 'Raise 2'))
        add(ToggleButton('tb3', gridded(7, 3), 2, False, 'Push 3', 'Raise 3'))
        add(ToggleButton('tb4', gridded(7, 4), 3, False, 'Push 4', 'Raise 4'))
        add(ToggleButton('tb5', gridded(7, 5), 4, False, 'Push 5', 'Raise 5'))
        ...
        self.toggle_life = add(ToggleButton('run', Rect(30, height - 38, 100, widget_height), 3, False, 'Stop', 'Start'))
