...
class Demo:
    def __init__(self):
        ...
        g.create('Label', g.gridded(3, 0), 'G4 Radioed', True)
        g.create('Label', g.gridded(4, 0), 'G5 Checked', True)
        ...
        self.label3 = g.create('Label', g.gridded(2, 0), f'ID: {lbg3.read_id()}', True)
        self.label4 = g.create('Label', g.gridded(3, 0), f'ID: {lbg4.read_id()}', True)
        self.label5 = g.create('Label', g.gridded(4, 0), f'ID: {lbg5.read_id()}', True)
        self.label6 = g.create('Label', g.gridded(5, 0), f'ID: {lbg6.read_id()}', True)
        ...
        self.life_win = g.create('Window', 'Conway\'s Game of Life', (x_pos, y_pos), (width, height))
        self.canvas = g.create('Canvas', 'life', Rect(10, 10, width - 20, height - (widget_height * 2)), canvas_callback=self.handle_canvas, automatic_pristine=True)
        ...
        self.mandel_win = g.create('Window', 'Mandelbrot', pos, (width, height))
        self.mandel_canvas = g.create('Canvas', 'mandel', mandel_overall)
        ...
        self.canvas1 = g.create('Canvas', 'can1', Rect(10, 10, chalfx + 10, chalfy + 10))
        self.canvas2 = g.create('Canvas', 'can2', Rect(13 + chalfx + 5, 10, chalfx + 10, chalfy + 10))
        self.canvas3 = g.create('Canvas', 'can3', Rect(10, 13 + chalfy + 5, chalfx + 10, chalfy + 10))
        self.canvas4 = g.create('Canvas', 'can4', Rect(13 + chalfx + 5, 13 + chalfy + 5, chalfx + 10, chalfy + 10))
