...
class Demo:
    def __init__(self):
        ...
        lbg1 = add(ButtonGroup('bg1b01', gridded(0, 1), 0, 'Box 1', 'bg1'))
        ...
        lbg2 = add(ButtonGroup('bg2b01', gridded(1, 1), 1, 'Round 1', 'bg2'))
        ...
        lbg3 = add(ButtonGroup('bg3b01', gridded(2, 1), 2, 'Angle 1', 'bg3'))
        ...
        lbg4= add(ButtonGroup('bg4b01', gridded(3, 1), 3, 'Radio 1', 'bg4'))
        ...
        lbg5 = add(ButtonGroup('bg5b01', gridded(4, 1), 4, 'Check 1', 'bg5'))
        ...
        lbg6 = add(ButtonGroup('bg6b01', gridded(5, 1), 0, 'Mix 1', 'bg6'))
        ...
        add(ButtonGroup('bg6b05', gridded(5, 5), 4, 'Mix 5', 'bg6'))
        ...
        self.label1 = add(Label(gridded(0, 0, True), '', True))
        self.label2 = add(Label(gridded(1, 0, True), '', True))
        self.label3 = add(Label(gridded(2, 0, True), '', True))
        self.label4 = add(Label(gridded(3, 0, True), '', True))
        self.label5 = add(Label(gridded(4, 0, True), '', True))
        self.label6 = add(Label(gridded(5, 0, True), '', True))
        self.label1.set_label(f'ID: {lbg1.read_armed()}')
        self.label2.set_label(f'ID: {lbg2.read_armed()}')
        self.label3.set_label(f'ID: {lbg3.read_armed()}')
        self.label4.set_label(f'ID: {lbg4.read_armed()}')
        self.label5.set_label(f'ID: {lbg5.read_armed()}')
        self.label6.set_label(f'ID: {lbg6.read_armed()}')
