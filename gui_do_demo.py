...
class Demo:
    def __init__(self):
        ...
        self.pb_win = Window('Pushbuttons, Buttons, and Togglebuttons', (50, 150), (998, 200))
        set_grid_properties((10, 10), 120, widget_height, 2)
        add(Label(gridded(0, 0), 'PB1 Boxed', True))
        add(Label(gridded(1, 0), 'PB2 Rounded', True))
        add(Label(gridded(2, 0), 'PB3 Angled', True))
        add(Label(gridded(3, 0), 'PB4 Radioed', True))
        add(Label(gridded(4, 0), 'PB5 Checked', True))
        add(Label(gridded(5, 0), 'PB6 Mixed', True))
