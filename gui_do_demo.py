...
class Demo:
    def __init__(self):
        ...
        self.label1 = add(Label(gridded(0, 0), f'ID: {lbg1.read_armed()}', True))
        self.label2 = add(Label(gridded(1, 0), f'ID: {lbg2.read_armed()}', True))
        self.label3 = add(Label(gridded(2, 0), f'ID: {lbg3.read_armed()}', True))
        self.label4 = add(Label(gridded(3, 0), f'ID: {lbg4.read_armed()}', True))
        self.label5 = add(Label(gridded(4, 0), f'ID: {lbg5.read_armed()}', True))
        self.label6 = add(Label(gridded(5, 0), f'ID: {lbg6.read_armed()}', True))
