...
class Demo:
    def __init__(self):
        ...
        self.window1_toggle = add(ToggleButton('toggle1', Rect(270, 1050, 170, 20), False, 'Togglebutton Visible'))
        self.window2_toggle = add(ToggleButton('toggle2', Rect(90, 1050, 170, 20), False, 'Window Visible'))
        # realize window
        ...
        # add a toggle button
        self.toggle = add(ToggleButton('toggle', Rect(15, 170, 145, 20), True, 'Image Visible'))
        # set cursor image
    ...
    def run(self):
        ...
        while self.running:
            # handle events
            self.handle_events()
            self.image.set_visible(self.toggle.read())
            self.toggle.set_visible(self.window1_toggle.read())
            self.win.set_visible(self.window2_toggle.read())
            new_areas = []
