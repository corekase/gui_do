...
- Do not collapse or remove `policy_specs`, `effect_bindings`, `event_pipelines`, `durable_queue_spec`, `capability_providers`, `capability_requirements`, `projection_spec`, or their `*_attr_name` mappings as "unused" if they are part of routed runtime composition.
