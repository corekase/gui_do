...
class Demo:
    def __init__(self):
        ...
        add(PushButtonGroup('pb5', gridded(1, 1), 1, 'Rounded 1', 'pb2'))
        add(PushButtonGroup('pb6', gridded(1, 2), 1, 'Rounded 2', 'pb2'))
        add(PushButtonGroup('pb7', gridded(1, 3), 1, 'Rounded 3', 'pb2'))
        add(PushButtonGroup('pb8', gridded(1, 4), 1, 'Rounded 4', 'pb2'))
        ...
        add(ToggleButton('tb1', gridded(5, 1), 0, False, 'Pushed 1', 'Raised 1'))
        add(ToggleButton('tb2', gridded(5, 2), 1, False, 'Pushed 2', 'Raised 2'))
