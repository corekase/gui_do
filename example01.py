...
class Demo:
    def __init__(self):
        ...
        self.pb_win = Window('Pushbuttons, Buttons, and Togglebuttons', (50, 150), (806, 168))
        set_grid_properties((10, 10), 110, widget_height, 2)
        add(Label(gridded(0, 0), 'Boxed', True))
        add(Label(gridded(1, 0), 'Rounded', True))
        add(Label(gridded(2, 0), 'Radioed', True))
        add(Label(gridded(3, 0), 'Checked', True))
        add(Label(gridded(4, 0), 'Mixed', True))
        add(Label(gridded(5, 0), 'Buttons', True))
        add(Label(gridded(6, 0), 'Toggled', True))
        ...
        add(PushButtonGroup('pb4', gridded(0, 4), 0, 'Box 4', 'pb1'))
        add(PushButtonGroup('pb5', gridded(1, 1), 1, 'Round 1', 'pb2'))
        add(PushButtonGroup('pb6', gridded(1, 2), 1, 'Round 2', 'pb2'))
        add(PushButtonGroup('pb7', gridded(1, 3), 1, 'Round 3', 'pb2'))
        add(PushButtonGroup('pb8', gridded(1, 4), 1, 'Round 4', 'pb2'))
        add(PushButtonGroup('pb9', gridded(2, 1), 2, 'Radio 1', 'pb3'))
        add(PushButtonGroup('pb10', gridded(2, 2), 2, 'Radio 2', 'pb3'))
        add(PushButtonGroup('pb11', gridded(2, 3), 2, 'Radio 3', 'pb3'))
        add(PushButtonGroup('pb12', gridded(2, 4), 2, 'Radio 4', 'pb3'))
        add(PushButtonGroup('pb13', gridded(3, 1), 3, 'Check 1', 'pb4'))
        add(PushButtonGroup('pb14', gridded(3, 2), 3, 'Check 2', 'pb4'))
        add(PushButtonGroup('pb15', gridded(3, 3), 3, 'Check 3', 'pb4'))
        add(PushButtonGroup('pb16', gridded(3, 4), 3, 'Check 4', 'pb4'))
        add(PushButtonGroup('pb17', gridded(4, 1), 0, 'Mix 1', 'pb5'))
        add(PushButtonGroup('pb18', gridded(4, 2), 1, 'Mix 2', 'pb5'))
        add(PushButtonGroup('pb19', gridded(4, 3), 2, 'Mix 3', 'pb5'))
        add(PushButtonGroup('pb20', gridded(4, 4), 3, 'Mix 4', 'pb5'))
        add(Button('b1', gridded(5, 1), 0, 'Button 1'))
        add(Button('b2', gridded(5, 2), 1, 'Button 2'))
        add(Button('b3', gridded(5, 3), 2, 'Button 3'))
        add(Button('b4', gridded(5, 4), 3, 'Button 4'))
        add(ToggleButton('tb1', gridded(6, 1), 0, False, 'Push 1', 'Raise 1'))
        add(ToggleButton('tb2', gridded(6, 2), 1, False, 'Push 2', 'Raise 2'))
        add(ToggleButton('tb3', gridded(6, 3), 2, False, 'Push 3', 'Raise 3'))
        add(ToggleButton('tb4', gridded(6, 4), 3, False, 'Push 4', 'Raise 4'))
        ...
        self.life_win = Window('Conway\'s Game of Life', (375, 346), (width, height))
