...
class Demo:
    def __init__(self):
        ...
        self.pb_win = Window('Pushbuttons and Togglebuttons', (50, 150), (694, 168))
        ...
        add(Label(gridded(5, 0), 'Toggled', True))
        ...
        add(ToggleButton('tb1', gridded(5, 1), 0, False, 'Push 1', 'Raise 1'))
        add(ToggleButton('tb2', gridded(5, 2), 1, False, 'Push 2', 'Raise 2'))
        add(ToggleButton('tb3', gridded(5, 3), 2, False, 'Push 3', 'Raise 3'))
        add(ToggleButton('tb4', gridded(5, 4), 3, False, 'Push 4', 'Raise 4'))
